...
Find the value of $k$. Enter the answer in the box provided as a decimal correct to four significant digits.
...
%% \extype{num}
%% \exsolution{\Sexpr{k}}
%% \exname{\Sexpr{paste0("Find_k_numerical_",Sys.Date())}}
%% \extol{0.0001}
%% \expoints{3}
